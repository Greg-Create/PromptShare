...
function profileTab() {
  ...
  function updateUserProfile(){
    ...
    }).eq('id',session.user.id).then(result=> {console.log(result) 
  ...
  return (
    <div className="myProfilePageContainer">
      <div className={`myProfileContainer ${userLoading? "transparent": ""}`}>
        {userLoading? <div className="loading2">  <Puff
          className="loading"
          height="100"
          width="100"
          radius={1}
        ...
        <div className="profileBlock">
          ...
          <div className="profileGrid">
            <div className="editName">
              ...
              <input
                value={
                  editName !== null ? editName : profile ? profile.name.includes(" ") ? profile.name.substring(0, profile.name.indexOf(' ')) :profile.name
                  : ""
                }
            ...
            <div className="editName">
              ...
              <input type="text" value={
                  editLastName !== null ? editLastName : profile ? profile.name.includes(" ") ? profile.name.substring( profile.name.indexOf(' ') + 1) : profile.lastname
                  : ""
            ...
            <div className="editName">
              <p>About Me</p>
              <textarea value={editAbout !==null? editAbout: profile? profile.about : ""} onChange={(e) => setEditAbout(e.target.value)} />
            </div>
            ...
            <button onClick={()=>updateUserProfile()} className="updateBtn">Update</button>
          </div>
        </div>
      </div>
      <div className="profilePictureContainer">
       
        <img className={`${uploading?"transparent": "border"}`} src={profile ? profile.avatar : ""} />
        {
          uploading? <div className="loading">  <Puff
          className="loading"
          height="80"
          width="80"
          radius={1}
        ...
        <div className="uploadButton">
          <label className="uploadPrfButton">Upload Profile Pic
